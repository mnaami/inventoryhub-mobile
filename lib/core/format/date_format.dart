...
final _dateTimeFormat = DateFormat('MMM d, y • HH:mm', 'en');
...
/// Like [formatDate] but includes the 24-hour time of day (e.g.
/// 'Jan 5, 2026 • 14:30'). Normalizes to local time first so UTC-stamped
