...
class PurchaseOrderSwipeableStatisticsSection extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PurchaseOrderSwipeableStatisticsSection> createState() =>
      _PurchaseOrderSwipeableStatisticsSectionState();
}

class _PurchaseOrderSwipeableStatisticsSectionState
    extends ConsumerState<PurchaseOrderSwipeableStatisticsSection> {
          ...
          SizedBox(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildKeyStatisticsContent(
  ...
  ({DateTime start, DateTime end}) _getDateRangeForPage(int pageIndex) {
    ...
    switch (pageIndex) {
      ...
      case 1: // Weekly
        ...
        final endOfWeek =
            DateTime(startOfWeek.year, startOfWeek.month, startOfWeek.day, 23, 59, 59)
  ...
  Widget _buildKeyStatisticsContent(
    ...
    return Row(
      children: [
        Expanded(
          child: Consumer(
            builder: (context, ref, child) {
              final countAsync = ref.watch(purchaseOrderCountProvider(
        ...
        Expanded(
          child: Consumer(
            builder: (context, ref, child) {
              final amountAsync = ref.watch(purchaseOrderAmountProvider(
                  (startDate: startDate, endDate: endDate)));
              return _buildCompactStatCard(
                context,
