...
mixin _$ProductionOrder {
 ...
 String get id; String get organizationId; String get orderNumber; String get productId; double get quantity; ProductionOrderStatus get status; DateTime? get startDate; DateTime? get completionDate; String? get notes; DateTime get createdAt; DateTime get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,organizationId,orderNumber,productId,quantity,status,startDate,completionDate,notes,createdAt,updatedAt);

@override
String toString() {
  return 'ProductionOrder(id: $id, organizationId: $organizationId, orderNumber: $orderNumber, productId: $productId, quantity: $quantity, status: $status, startDate: $startDate, completionDate: $completionDate, notes: $notes, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String organizationId, String orderNumber, String productId, double quantity, ProductionOrderStatus status, DateTime? startDate, DateTime? completionDate, String? notes, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of ProductionOrder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? organizationId = null,Object? orderNumber = null,Object? productId = null,Object? quantity = null,Object? status = null,Object? startDate = freezed,Object? completionDate = freezed,Object? notes = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String organizationId,  String orderNumber,  String productId,  double quantity,  ProductionOrderStatus status,  DateTime? startDate,  DateTime? completionDate,  String? notes,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductionOrder() when $default != null:
return $default(_that.id,_that.organizationId,_that.orderNumber,_that.productId,_that.quantity,_that.status,_that.startDate,_that.completionDate,_that.notes,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _ProductionOrder extends ProductionOrder {
  const _ProductionOrder({required this.id, required this.organizationId, required this.orderNumber, required this.productId, required this.quantity, required this.status, this.startDate, this.completionDate, this.notes, required this.createdAt, required this.updatedAt}): super._();
...
/// Create a copy of ProductionOrder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? organizationId = null,Object? orderNumber = null,Object? productId = null,Object? quantity = null,Object? status = null,Object? startDate = freezed,Object? completionDate = freezed,Object? notes = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
